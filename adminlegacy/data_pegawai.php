...
<head>
    ...
    <title>DATA PEGAWAI-LEGACY</title>
    ...
    <div class="container">
        <div class="panel">
            <div class="panel-body">
                ...
                <a href="tambah_pegawai.php" class="btn0 btn-sm pull-left">Tambah Data Pegawai</a>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_pegawai.php?id=<?php echo $d['id']; ?>" class="btn btn-sm btn-primary">Update</a>
                                <a href="hapus_pegawai.php?id=<?php echo $d['id']; ?>" onclick="hey()" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php
                    }
