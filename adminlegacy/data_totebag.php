        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    $data = mysqli_query($koneksi, "select * from totebag");
                    //$no = 1
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_totebag.php?id=<?php echo $d['id']; ?>" class="btn btn-sm btn-primary">Update</a>
                                <a href="hapus_totebag.php?id=<?php echo $d['id']; ?>" onclick="hey()" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php
                    }
