        ...
        <div class="container">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    $data = mysqli_query($koneksi, "select * from totebag where id='$id'");
                    ...
                    ?>
                        ...
                        <form method="post" action="update_totebag.php">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama" placeholder="Masukkan nama totebag" value="<?php echo $d['nama']; ?>">
                            </div>
