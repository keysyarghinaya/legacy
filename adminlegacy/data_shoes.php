...
<head>
    ...
    <title>DATA KATEGORI SHOES-LEGACY</title>
    ...
    <div class="container">
        <div class="panel">
            <div class="panel-body">
                ...
                <a href="tambah_shoes.php" class="btn0 btn-sm pull-left">Tambah Data Shoes</a>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    $data = mysqli_query($koneksi, "select * from shoes");
                    //$no = 1
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_shoes.php?id=<?php echo $d['id']; ?>" class="btn btn-sm btn-primary">Update</a>
                                <a href="hapus_shoes.php?id=<?php echo $d['id']; ?>" onclick="hey()" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php
                    }
